...
\begin{document}
	\includepdf[pages={1}]{scan-of-declaration-of-authorship2.pdf}
	\pagebreak
	...
	{\noindent\LARGE\textbf{Bayesian Estimation of the Stochastic Volatility Model with Leverage: \\The case of Germany and China}}
    ...
    It contrasts an intuitive phenomenon called the leverage effect, which has a history going back even to the 1970s.
    ...
    Although most of them are ARCH-type models, we use a promising alternative called the Stochastic Volatility (SV) model with leverage.
    It has not been applied to Chinese stock datasets yet, and it has better in-sample-fit than its corresponding, similarly sophisticated GARCH models.
